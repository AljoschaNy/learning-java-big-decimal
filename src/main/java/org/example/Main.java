...
public class Main {
    public static void main(String[] args) {
        ...
        accounts.add(new Account("ac1", new BigDecimal("10000") ,client1));
        accounts.add(new Account("ac2", new BigDecimal("10000") ,client2));
        accounts.add(new Account("ac3", new BigDecimal("10000") ,client3));
        accounts.add(new Account("ac4", new BigDecimal("10000") ,client4));
